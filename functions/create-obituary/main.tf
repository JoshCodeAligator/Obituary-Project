...
locals {
  function_name = "create-obituary-30116268"
    ...
    Statement = [
      {
        ...
        Resource = "arn:aws:ssm:ca-central-1:192126134242:parameter/*"
      }
    ]
  })
}
...
# create a policy for Polly
resource "aws_iam_policy" "polly_synthesize_speech_policy" {
  name        = "polly-CRE"
  description = "Policy for allowing SynthesizeSpeech action in Polly"
    ...
    Statement = [
      {
        ...
        Resource = [
          "arn:aws:dynamodb:ca-central-1:192126134242:table/Obituary-30144922"
        ]
      }
    ]
  })
